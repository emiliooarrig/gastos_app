...
$suma = (int) $resultado['total'];  // ahora es un entero
...
<body>
    ...
    <div class="contenedor">
        <div class="inside">
            ...
            <div class="botones">
                <a href="agregar/agregar.php" class="btn btn-agregar"> Agregar gasto </a>
                <a href="" class="btn btn-eliminar"> Eliminar gasto </a>
            </div>
